-- Simple Update Professional Titles Schema
-- This version avoids constraint issues and focuses on the essential changes
...
-- Step 3: Clear existing data and insert new titles
