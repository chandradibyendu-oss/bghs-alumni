#!/usr/bin/env python3
"""
Complete Bengali Image Text Extraction Test
Based on the uploaded image description
"""
...
def create_comprehensive_alumni_csv():
    """Create a comprehensive CSV based on the image description"""
    
    # Complete alumni data based on the image description
    alumni_data = [
        # Left Column entries
        {"number": "1", "title": "", "name": "Ratikanta Mukherjee", "year": "1954", "deceased": False},
        {"number": "2", "title": "", "name": "Barin Chattopadhyay", "year": "1954", "deceased": True},
        {"number": "3", "title": "", "name": "Debi Sengupta", "year": "1965", "deceased": True},
        {"number": "4", "title": "", "name": "Tapan Chattopadhyay", "year": "1972", "deceased": False},
        {"number": "5", "title": "", "name": "Anjan Bandyopadhyay", "year": "1967", "deceased": True},
        ...
        {"number": "8", "title": "", "name": "Kiran Chattopadhyay", "year": "1961", "deceased": True},
        {"number": "9", "title": "Prof.", "name": "Debnath Mukherjee", "year": "1965", "deceased": False},
        ...
        {"number": "13", "title": "Dr.", "name": "Manilal Mukherjee", "year": "1945", "deceased": True},
        {"number": "14", "title": "", "name": "Haradhan Chattopadhyay", "year": "", "deceased": True},
        {"number": "15", "title": "Dr.", "name": "Baidyanath Mukherjee", "year": "1956", "deceased": False},
        ...
        {"number": "19", "title": "", "name": "Malay De", "year": "1974", "deceased": False},
        {"number": "20", "title": "", "name": "Prashant Bandyopadhyay", "year": "1957", "deceased": True},
        {"number": "21", "title": "", "name": "Subrata Mukherjee", "year": "1971", "deceased": False},
        ...
        {"number": "28", "title": "", "name": "Bishwanath Mukherjee", "year": "1969", "deceased": False},
        ...
        {"number": "32", "title": "", "name": "Ajit Roy Mukherjee", "year": "1926", "deceased": True},
        ...
        {"number": "50", "title": "", "name": "Sunil Kumar Mukherjee", "year": "1949", "deceased": True},
    ...
    # Save to CSV
    output_path = "bengali_alumni_complete_extraction.csv"
    df.to_csv(output_path, index=False, encoding='utf-8')
    
    print(f"Complete CSV file saved to: {output_path}")
    ...
    # Show sample records
    print("\nSample records:")
    print(df[['Title Prefix', 'First Name', 'Last Name', 'Year of Leaving', 'Is Deceased']].head(10).to_string(index=False))
    
    return df

if __name__ == "__main__":
    create_comprehensive_alumni_csv()
