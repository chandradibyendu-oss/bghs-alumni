...
// Optional: register a clean font for better look
// Font.register({ family: 'Inter', src: 'https://fonts.gstatic.com/s/inter/v12/UcCO3Fwr2q1xd7tYrmE.ttf' })
...
const styles = StyleSheet.create({
  ...
  gridLabel: { width: '35%', fontSize: 10, fontWeight: 700, color: '#374151' },
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Image style={styles.headerLogo} src={LogoSource()} />
        ...
        <View style={styles.section}>
          ...
          <Text style={{ fontSize: 10, color: '#6b7280' }}>[Space for admin verification notes and approval decision]</Text>
        </View>
